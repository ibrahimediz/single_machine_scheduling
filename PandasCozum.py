...
table_list = []
new_table_list = []
for filename in os.listdir(r"E:\Projelerim\single_machine_scheduling\DENEME CSV SETLER\DENEME CSV SETLER\I=15, J=20"):
...
for item in new_table_list:
    OkuBakalım(item.split(".")[0],r"E:\Projelerim\single_machine_scheduling\DENEME CSV SETLER\DENEME CSV SETLER\I=15, J=20",r"\I15_J20.txt",item,Job=20,Order=15)
